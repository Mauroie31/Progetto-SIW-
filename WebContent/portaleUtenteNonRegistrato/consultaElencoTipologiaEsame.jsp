...
<title>Tipologie d'esame proposte</title>
			...
			<h:form>
				<div align="center" class="header-content">
					<div class="header-content-inner">
						<h1 style="color: #EE4B28; font-size: 40px;">Tipologie
							d'esame proposte</h1>
						<hr>

						<c:forEach var="tipologiaEsame"
							items="#{tipologiaEsameController.tipologieEsami}">
							<br>
            <strong style="color: black;">${tipologiaEsame.nome}  <h:commandButton
								value="Chiedi Dettagli"
								action="#{tipologiaEsameController.vaiSuPaginaDettagliTipologia(tipologiaEsame.id)}" /></strong><br>

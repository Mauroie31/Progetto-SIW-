			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a href="./inserisciTipologiaEsame.jsp">Crea
								esame</a></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
			...
			<h:form>
				<div align="center" class="header-content">
					<div class="header-content-inner">
						<h1 style="color: #EE4B28; font-size: 40px;">Inizia
							compilazione esame</h1>
						<hr>

						<strong style="color: #000000">Inserisci La data della
							visita (formato **-**-****)</strong>
						<div>
							<h:inputText style="color: black;"
								value="#{esameController.dataVisita}">
								<f:convertDateTime pattern="dd-MM-yyyy" />
							</h:inputText>
						</div>

						<strong style="color: #000000">Inserisci ID Paziente:</strong>
						<div>
							<h:inputText style="color: black;"
								value="#{esameController.id_utente}" />
						</div>

						<strong style="color: #000000">Inserisci ID Medico:</strong>
						<div>
							<h:inputText style="color: black;"
								value="#{esameController.nome_medico}" />
						</div>
